...
#
# LibFuzzer replaces main() and requires instrumentation at both compile and
# link time.  ASan is paired unconditionally: fuzzer+address is the standard
# combination and catches memory errors in the code under test.
# -fno-omit-frame-pointer preserves stack frames for readable crash reports.
